          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: ABTextstyle.subtitleBold.copyWith(color: Colors.white),
              ),
              const SizedBox(height: 20),
              Text(
                ABTexts.onboardingDesc,
                style: ABTextstyle.body1.copyWith(color: ABColors.stone),
              ...
              Row(
                ...
                children: [
                  Text(
                    ABTexts.contAs,
                    style: ABTextstyle.body1Bold.copyWith(color: Colors.white),
                  ),
                  const SizedBox(width: 4),
                  Text(
                    ABTexts.aGuest,
                    style:
                        ABTextstyle.body1Bold.copyWith(color: ABColors.accent),
                  )
                ],
              ),
              const SizedBox(height: 64)
